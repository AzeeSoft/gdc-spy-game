...
//		DebugExtension.DrawCircle(position+(_forward*0.75f), direction, color, ((_forward*0.75f)-(slerpedVector.normalized*(dist*0.75f))).magnitude);
...
//		DebugExtension.DrawCircle(position+(_forward*0.25f), direction, color, ((_forward*0.25f)-(slerpedVector.normalized*(dist*0.25f))).magnitude);
